...
CREATE TABLE Usuarios (
	...
	data_alteracao DATE NOT NULL CONSTRAINT DF_DATAALTERACAO DEFAULT GETDATE(),
...
--ADD data_modificacao DATE CONSTRAINT DF_DATAMODIFICACAOCLIENTES DEFAULT GETDATE()
...
CREATE TABLE Clientes (
	...
	idade INT,
	data_modificacao DATE CONSTRAINT DF_DATAMODIFICACAOCLIENTES DEFAULT GETDATE(),
...
--ADD data_modificacao DATE CONSTRAINT DF_MODIFICACAOENTRADA DEFAULT GETDATE()
...
CREATE TABLE Nota_Entrada (
	...
	data_modificacao DATE CONSTRAINT DF_MODIFICACAOENTRADA DEFAULT GETDATE()
	qtde INT NOT NULL,
...
CREATE TABLE Nota_Saida (
	...
	id_produto INT NOT NULL,
	qtde INT NOT NULL,
	data_modificacao DATE CONSTRAINT DF_MODIFICNOTASAIDA DEFAULT GETDATE(),
...
BEGIN
    UPDATE Usuarios
    SET Usuarios.data_alteracao = GETDATE()
    FROM Usuarios
